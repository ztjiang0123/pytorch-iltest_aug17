...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        self,
        projection: PatchEmbedProjection = None,
        in_chans: int = 3,
        embed_dim: int = 768,
    ):
        """
        Args:
            projection (PatchEmbedProjection): kernel size, stride, and padding
        ...
        if projection is None:
            projection = PatchEmbedProjection()
        self.proj = nn.Conv2d(
            in_chans,
            embed_dim,
