...
def _get_act_qspec(quantization_config: Optional[QuantizationConfig], activation):
    """Return the validated activation ``QuantizationSpec`` or ``None``.

    Shared by :func:`get_input_act_qspec` and :func:`get_output_act_qspec`;
    ``activation`` is the (input or output) activation spec pulled off the
    config.
    """
